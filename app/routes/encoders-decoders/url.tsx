...
import { usePage } from "./+url/use-page";

export const meta: Route.MetaFunction = () => [
  { title: pageTitle(toolGroups.encodersDecoders.tools.url.longTitle) },
  {
    name: "description",
    content: toolGroups.encodersDecoders.tools.url.description,
  },
