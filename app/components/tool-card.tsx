...
export type ToolCardProps = Pick<Tool, "Icon" | "longTitle" | "description" | "path">;

export function ToolCard({ Icon, longTitle, description, path }: ToolCardProps) {
  return (
    <Link className="rounded" to={path} prefetch="viewport">
      <div
        className={cn(
